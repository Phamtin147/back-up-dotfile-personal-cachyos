...
Item {
  ...
  readonly property bool showOnlyFocused: (widgetSettings.showOnlyFocused !== undefined) ? widgetSettings.showOnlyFocused : widgetMetadata.showOnlyFocused
  ...
  function refreshWorkspaces() {
    ...
    if (screen !== null) {
      ...
      for (var i = 0; i < CompositorService.workspaces.count; i++) {
        ...
        if (!matchesScreen)
          continue;
        if (showOnlyFocused && !ws.isFocused)
          continue;
